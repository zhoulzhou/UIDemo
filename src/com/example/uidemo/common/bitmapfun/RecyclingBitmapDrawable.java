...
//		LogUtil.v("yangzc", "checkState, mCacheRefCount:" + mCacheRefCount + ", mDisplayRefCount:" + mDisplayRefCount + ", mHasBeenDisplayed:" + mHasBeenDisplayed
//				+", hasValidBitmap:"+hasValidBitmap());
		...
		if (mCacheRefCount <= 0 && mDisplayRefCount <= 0 && mHasBeenDisplayed && hasValidBitmap()) {
			...
			LogUtil.d(LOG_TAG, "No longer being used or cached so recycling. " + toString());
			getBitmap().recycle();
		}
	}
