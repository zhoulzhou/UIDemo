package com.example.uidemo.ui.widget;
...
public class DocIndicator extends View {
	...
	private int mDotPadding; //点和点之间距离
	...
	public DocIndicator(Context context, AttributeSet att, int defStyle) {
		...
		mDotPadding = a.getDimensionPixelSize(R.styleable.DocIndicator_dotPadding,
				6);
	...
	public void setTotal(int total) {
		...
		parmas.width = total * mDotWidth + (total-1) * mDotPadding;
